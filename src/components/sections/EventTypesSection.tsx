...
const eventData: Record<string, { intro: string; whatWeDo: string[]; florals: string[]; setup: string[] }> = {
  ...
  'Openings & Ceremonies': {
    intro: 'Grand openings and ceremonies mark the beginning of something important. Firenze Flora creates floral environments that honour the occasion: ribbon cutting ceremonies, venue openings, and official launches, delivered with the scale and elegance the moment deserves.',

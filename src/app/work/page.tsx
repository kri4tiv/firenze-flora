  ...
  return (
    <>
      <div className="pt-32 pb-16 container-site">
        <span className="font-accent text-[#B8963E] text-xs tracking-widest uppercase block mb-4">Selected Work</span>
        <h1 className="font-display text-display-lg text-[#1C1C1A]">Work</h1>
      </div>
      <WorkGrid />
      <EnquireCTA />
    </>

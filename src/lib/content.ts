...
export const SERVICES = {
  weddings: {
    ...
    metaDescription: "Premium wedding floral decor in Dubai. Arabic, Indian, Iranian, Western and destination weddings. Reception styling, arches, centrepieces, flower walls. Enquire today.",
    ...
    faqs: [
      { question: "How far in advance should I book?", answer: "We recommend enquiring at least 3 to 6 months ahead. Peak season, October to April, books quickly, though we can accommodate shorter timelines depending on availability." },
